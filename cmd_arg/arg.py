...
async def parse_cmd(argv: Optional[Sequence[str]] = None):
    ...
    def main(
        ...
        start_time: Annotated[
            ...
            typer.Option(
                "--start_time",
                help="Content publish start date, format YYYY-MM-DD, empty for no limit",
                rich_help_panel="Basic Configuration",
            ),
        ] = config.START_TIME,
        end_time: Annotated[
            ...
            typer.Option(
                "--end_time",
                help="Content publish end date, format YYYY-MM-DD, empty for no limit",
                rich_help_panel="Basic Configuration",
            ),
        ] = config.END_TIME,
        keywords: Annotated[
        ...
        config.START_TIME = (start_time or "").strip()
        config.END_TIME = (end_time or "").strip()
