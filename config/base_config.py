...
# Content publish time filter (Douyin search/detail/creator)
# Format: YYYY-MM-DD. Empty value means no limit.
START_TIME = ""
END_TIME = ""
...
# Risk control wait-and-retry
# When a video detail request is blocked by Douyin risk control, wait and retry only the failed videos.
